...
### Why you should program your own text adventure
While there are of course software systems available that can generate these types of games for you, programming your own adventure will teach you valuable lessons in game design and solving the various problems in creating a game of any kind. The concepts used in creating a text adventure can be applied to any type of game. A text adventure is a very good first project for someone who is beginning programming or has just learned a new language. It will force you to thimk about what you are doing with the language and how you apply the language to a relatively large project.
